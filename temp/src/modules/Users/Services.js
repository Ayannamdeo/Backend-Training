...
class UserServices {
    constructor() {
        ...
        this.deleteUser = (email) => __awaiter(this, void 0, void 0, function* () {
            return yield this.userRepository.delete(email);
        });
...
_a = UserServices;
UserServices.generateJwtToken = (existingUser, jwtsecret) => {
    return jsonwebtoken_1.default.sign({ userName: existingUser.name }, jwtsecret, {
        expiresIn: 20,
    });
};
