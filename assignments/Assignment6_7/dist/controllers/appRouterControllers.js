...
exports.AppRouterControllers = void 0;
...
class AppRouterControllers {
    ...
    static handleCreateUser(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            fs_1.default.writeFile("./assignments/Assignment6_7/src/utils/MOCK_DATA.json", JSON.stringify(MOCK_DATA_json_1.default), (err) => {
                if (err)
...
exports.AppRouterControllers = AppRouterControllers;
